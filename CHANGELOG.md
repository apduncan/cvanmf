...
summaries for some module and overall package added. ([`4b48520`](https://github.com/apduncan/cvanmf/commit/4b48520fe37239f86a3347acc3594d35bf1e401d))

### Feature

* feat(stability): add methods to show stability of signatures (#10)

* feat(stability): allow use of signature similarity as rank selection method. ([`870cd84`](https://github.com/apduncan/cvanmf/commit/870cd842f15e8b5a8288226e091ff9df7cd827ab))
